...
namespace RayNeo
{
    ...
    public class GestureManager
    {
        ...
        public void Start(int w = 640, int h = 480, int f = 20)
        {
            ...
            return;
#endif
            Debug.Log("[GestureManager.Init.MercuryX2]开启算法");
        ...
        public void Stop()
        {
            ...
            Debug.Log("[GestureManager.Stop.MercuryX2]:算法模块关闭");
        ...
        public sealed class SetMotionListener : AndroidJavaProxy
        {
            ...
            {
                Debug.Log("[SetMotionListener.MercuryX2]:SetMotionListener");
        ...
        public string GetCacheDir()
        {
            using (var CacheDir = GetUnityActivity().Call<AndroidJavaObject>("getCacheDir"))
            {
                ...
                Debug.Log("[GestureManager.GestureManagerMercuryX2]:cache path|" + path);
                return path;
            }
        }
    }
